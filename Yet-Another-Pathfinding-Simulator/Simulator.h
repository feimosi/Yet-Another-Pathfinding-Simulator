...
namespace yaps {
    ...
    class Simulator {
        ...
        Graph graph;                    // A* path-finding algorithm
        ...
        std::vector<Coordinates> &refToGraphPath; //Path generated by the A*
        unsigned graphPathIndex;                      //Index of next A* path point to draw
    ...
    public:
        ...
        /**
         *  @return next coordinates in the graph path
         */
        Coordinates nextGraphPoint();

        /**
         *  @return current coordinates in the graph path
         */
        Coordinates currentGraphPoint() { return refToGraphPath[graphPathIndex]; }
    };
